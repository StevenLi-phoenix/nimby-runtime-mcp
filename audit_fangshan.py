"""Partitioned live Fangshan Line curve, crossing and build audit."""
import json
...
def run():
    ...
    assert len(ids)<5000
    existing={}
    for line_id in ['1125899906842625','1125899906973697','1125899907039233','1125899907104769','1125899907170305','1125899907301377','1125899907366913','1125899907432449','1125899907497985','1125899907563521']:
    ...
    Path('work/fangshan-curve-audit.json').write_text(json.dumps(result,ensure_ascii=False,indent=2),encoding='utf-8')
