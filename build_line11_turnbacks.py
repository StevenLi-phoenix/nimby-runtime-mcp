"""Add Line 11 station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/line11-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 4 and all(n['blueprint'] for n in before['nodes'])
