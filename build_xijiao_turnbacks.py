"""Add Xijiao Line station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/xijiao-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 6 and all(n['blueprint'] for n in before['nodes'])
