"""Connect current Line 7 station blueprints; never build or restore old station geometry."""
import bisect
import json
import math
import sys
...
CHECKPOINT = Path('work/line7-corridors.json')


def run():
    stations = json.loads(Path('work/line7-built.json').read_text(encoding='utf-8'))['stations']
    plan = json.loads(Path('data/line7_plan.json').read_text(encoding='utf-8'))
