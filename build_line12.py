"""Create Line 12 station blueprints only; never commit construction implicitly."""
import hashlib
import json
import math
...
CHECKPOINT = Path('work/line12-built.json')


def run():
    raw = Path('data/line12_plan.json').read_bytes()
    plan = json.loads(raw)
