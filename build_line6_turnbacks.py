"""Add Line 6 station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/line6-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 36 and all(n['blueprint'] for n in before['nodes'])
