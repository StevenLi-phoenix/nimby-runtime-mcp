"""Partitioned live Line 15 curve, crossing and build audit."""
import json
...
def run():
    ...
    assert len(ids)<5000
    existing={}
    for line_id in ['1125899906842625','1125899906973697','1125899907039233','1125899907104769','1125899907170305','1125899907301377','1125899907366913','1125899907432449']:
    ...
    Path('work/line15-curve-audit.json').write_text(json.dumps(result,ensure_ascii=False,indent=2),encoding='utf-8')
