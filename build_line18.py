"""Create Line 18 station blueprints only; never commit construction implicitly."""
import hashlib
import json
import math
...
CHECKPOINT = Path('work/line18-built.json')


def run():
    raw = Path('data/line18_plan.json').read_bytes()
    plan = json.loads(raw)
