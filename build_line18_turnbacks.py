"""Add Line 18 station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/line18-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 11 and all(n['blueprint'] for n in before['nodes'])
