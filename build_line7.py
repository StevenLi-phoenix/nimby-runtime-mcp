"""Create Line 7 station blueprints only; never commit construction implicitly."""
import hashlib
import json
import math
...
CHECKPOINT = Path('work/line7-built.json')


def run():
    raw = Path('data/line7_plan.json').read_bytes()
    plan = json.loads(raw)
