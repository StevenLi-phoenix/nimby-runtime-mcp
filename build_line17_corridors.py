"""Connect current Line 17 station blueprints; never build or restore old station geometry."""
import bisect
import json
import math
import sys
...
CHECKPOINT = Path('work/line17-corridors.json')


def run():
    stations = json.loads(Path('work/line17-built.json').read_text(encoding='utf-8'))['stations']
    plan = json.loads(Path('data/line17_plan.json').read_text(encoding='utf-8'))
