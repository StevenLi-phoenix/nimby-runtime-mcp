"""Add Line 19 station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/line19-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 10 and all(n['blueprint'] for n in before['nodes'])
