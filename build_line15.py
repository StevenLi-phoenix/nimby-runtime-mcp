"""Create Line 15 station blueprints only; never commit construction implicitly."""
import hashlib
import json
import math
...
CHECKPOINT = Path('work/line15-built.json')


def run():
    raw = Path('data/line15_plan.json').read_bytes()
    plan = json.loads(raw)
