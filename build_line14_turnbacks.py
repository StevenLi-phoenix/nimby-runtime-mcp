"""Add Line 14 station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/line14-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 33 and all(n['blueprint'] for n in before['nodes'])
