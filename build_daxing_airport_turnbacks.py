"""Add Daxing Airport Line station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/daxing_airport-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 3 and all(n['blueprint'] for n in before['nodes'])
