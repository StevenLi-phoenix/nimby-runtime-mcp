"""Add Line S1 station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/s1-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 8 and all(n['blueprint'] for n in before['nodes'])
