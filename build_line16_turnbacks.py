"""Add Line 16 station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/line16-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 30 and all(n['blueprint'] for n in before['nodes'])
