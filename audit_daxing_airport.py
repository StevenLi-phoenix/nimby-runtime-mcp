"""Partitioned live Daxing Airport Line curve, crossing and build audit."""
import json
...
def run():
    ...
    Path('work/daxing_airport-curve-audit.json').write_text(json.dumps(result,ensure_ascii=False,indent=2),encoding='utf-8')
