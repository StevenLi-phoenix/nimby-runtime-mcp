"""Create Line 3 station blueprints only; never commit construction implicitly."""
import hashlib
import json
import math
...
CHECKPOINT = Path('work/line3-built.json')


def run():
    raw = Path('data/line3_plan.json').read_bytes()
    plan = json.loads(raw)
