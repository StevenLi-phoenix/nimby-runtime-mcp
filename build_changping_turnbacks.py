"""Add Changping Line station-after reversals from live endpoints, preserving player edits."""
import json
import math
...
CHECKPOINT = Path('work/changping-station-after-turnbacks.json')
...
def run():
    ...
    assert len(stations) == 20 and all(n['blueprint'] for n in before['nodes'])
