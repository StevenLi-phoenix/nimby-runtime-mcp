"""Connect current Line 3 station blueprints; never build or restore old station geometry."""
import bisect
import json
import math
import sys
...
CHECKPOINT = Path('work/line3-corridors.json')


def run():
    stations = json.loads(Path('work/line3-built.json').read_text(encoding='utf-8'))['stations']
    plan = json.loads(Path('data/line3_plan.json').read_text(encoding='utf-8'))
