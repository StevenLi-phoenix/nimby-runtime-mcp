"""Partitioned live Line S1 curve, crossing and build audit."""
import json
...
def run():
    ...
    Path('work/s1-curve-audit.json').write_text(json.dumps(result,ensure_ascii=False,indent=2),encoding='utf-8')
